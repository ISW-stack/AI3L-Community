...
MAX_EDITOR_FILE_SIZE = 10 * 1024 * 1024  # 10 MB
...
RATE_LIMIT_FILE_UPLOAD = _rate_limit("FILE_UPLOAD", 5, 60)
RATE_LIMIT_FORM_SUBMIT = _rate_limit("FORM_SUBMIT", 5, 60)
RATE_LIMIT_FORM_EXPORT = _rate_limit("FORM_EXPORT", 3, 300)  # 3 per 5 min per form
...
RATE_LIMIT_INVITE_VERIFY = _rate_limit("INVITE_VERIFY", 10, 60)
...
RATE_LIMIT_APPLY_MEMBER = _rate_limit("APPLY_MEMBER", 3, 3600)  # 3 per hour
RATE_LIMIT_REVIEW_APPLICATION = _rate_limit("REVIEW_APP", 30, 60)  # 30 per minute
...
ALBUM_MAX_COVER_SIZE_BYTES = 5 * 1024 * 1024  # 5 MB
ALBUM_MAX_ZIP_SIZE_BYTES = 50 * 1024 * 1024  # 50 MB (aligned with MAX_ALBUM_UPLOAD_BYTES)
...
RATE_LIMIT_CO_AUTHOR_EXTERNAL = _rate_limit("CO_AUTHOR_EXTERNAL", 10, 60)
...
DM_TEXT_EXPIRY_DAYS = 7  # Was 30 — reduced to limit exposure window for private messages
DM_MAX_ATTACHMENT_SIZE = 10 * 1024 * 1024  # 10 MB — DM attachments are PDFs/screenshots, not albums
RATE_LIMIT_DM_SEND = _rate_limit("DM_SEND", 30, 60)
RATE_LIMIT_DM_CONV_LIST = _rate_limit("DM_CONV_LIST", 60, 60)
RATE_LIMIT_DM_MSG_LIST = _rate_limit("DM_MSG_LIST", 60, 60)
RATE_LIMIT_DM_EDIT = _rate_limit("DM_EDIT", 30, 60)
RATE_LIMIT_DM_RECALL = _rate_limit("DM_RECALL", 20, 60)
RATE_LIMIT_DM_MARK_READ = _rate_limit("DM_MARK_READ", 60, 60)

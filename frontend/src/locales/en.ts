export default {
  ...
  auth: {
    ...
    captchaSwitchMath: 'Switch to math captcha',
    captchaSwitchRegular: 'Switch to regular captcha',
    captchaMathPlaceholder: 'Enter the answer',
  ...
  dm: {
    ...
    friendsOnlyLabel: 'Friends-only mode ON — only friends can message you',
    openToAllLabel: 'Anyone can message you',
    viewProfile: "View {name}'s profile",
    failedToSend: 'Failed to send message.',
    sendError: {
      friendsOnly: 'This user only accepts messages from friends.',
      cannotMessage: 'You cannot message this user.',
      windowExpired: 'The edit/recall window (12 hours) has expired.',
      cannotSelf: 'You cannot message yourself.',
      quotaExceeded: 'Storage quota exceeded (1 GB limit).',
      fileTooLargeError: 'File too large (max 10 MB).',
      alreadyRecalled: 'This message has already been recalled.',
      cannotEditRecalled: 'Cannot edit a recalled message.',
      editOwn: 'You can only edit your own messages.',
      recallOwn: 'You can only recall your own messages.',
      noPermission: 'You do not have permission to perform this action.',
    },
    failedToRecall: 'Failed to recall message.',
    readAt: 'Read {time}',
    unreadMessages: '{count} unread message | {count} unread messages',
  },
  ...
  home: {
    ...
    applyMembership: {
      ...
      usernameHint:
        "Letters, numbers, underscores, hyphens, dots, and {'@'} only. No spaces. You can set a Display Name with spaces later in your profile.",
  ...
  qa: {
    ...
    fetchTrendingError: 'Failed to load trending questions.',
    searchError: 'Search failed. Please try again.',
    searchLoading: 'Searching...',
    noMoreQuestions: 'No more questions to load',
    ...
    sidebar: {
      aboutTitle: 'About Q&A',
      aboutDescription: 'Ask questions and get answers from the community.',
      categoriesTitle: 'Categories',
      allQuestions: 'All Questions',
      trendingTitle: 'Trending Questions (7d)',
  ...
  coauthors: {
    ...
    removeConfirm: 'Are you sure you want to remove this co-author?',
    withPrefix: 'with',

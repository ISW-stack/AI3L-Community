export default {
  ...
  post: {
    ...
    detail: {
      ...
      unsavedChangesMessage: 'Tienes cambios no guardados. ¿Seguro que quieres salir de esta página?',
      leaveBtn: 'Salir',
    },
    comment: {
      reply: 'Responder',
  ...
  forms: {
    builder: {
      ...
      confirmDiscard: '¿Seguro que quieres descartar este borrador? Esta acción no se puede deshacer.',

export default {
  ...
  auth: {
    ...
    errors: {
      ...
      captcha_invalid: 'Неверная капча. Пожалуйста, попробуйте еще раз.',
      account_inactive: 'Ваш аккаунт неактивен. Пожалуйста, свяжитесь с администратором.',
      unknown: 'Ошибка входа. Пожалуйста, попробуйте еще раз.',
  ...
  errors: {
    ...
    captcha_invalid: 'Неверная капча. Пожалуйста, попробуйте еще раз.',
    SYS_422: 'Неверная капча. Пожалуйста, попробуйте еще раз.',
    account_inactive: 'Ваша учетная запись неактивна. Пожалуйста, свяжитесь с администратором.',
    unknown: 'Ошибка входа. Пожалуйста, попробуйте еще раз.',
    sessionExpired: 'Ваша сессия истекла. Пожалуйста, войдите снова.',
    loginFailed: 'Ошибка входа. Пожалуйста, попробуйте еще раз.',
    registerFailed: 'Ошибка регистрации. Пожалуйста, попробуйте еще раз.',
    guestLoginFailed: 'Ошибка гостевого входа. Пожалуйста, попробуйте еще раз.',

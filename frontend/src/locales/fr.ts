export default {
  ...
  auth: {
    ...
    usernameFormat: "Le nom d'utilisateur ne peut contenir que des lettres, des chiffres, des underscores, des tirets, des points et @.",
  ...
  forms: {
    ...
    view: {
      ...
      deadlinePassed: "La date limite de ce formulaire est passée. Les soumissions ne sont plus acceptées.",

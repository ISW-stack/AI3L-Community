export default {
  ...
  post: {
    ...
    detail: {
      ...
      unsavedChangesMessage: 'Hai modifiche non salvate. Sei sicuro di voler lasciare questa pagina?',
      leaveBtn: 'Lascia',
    },
    comment: {
      reply: 'Rispondi',
  ...
  forms: {
    builder: {
      ...
      confirmDiscard: 'Sei sicuro di voler eliminare questa bozza? Questa azione non può essere annullata.',

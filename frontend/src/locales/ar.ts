export default {
  ...
  branding: {
    ...
    description:
      'تواصل مع الباحثين والمعلمين الذين يدفعون مستقبل تعلم اللغات بالذكاء الاصطناعي.',
  },
  ...
  forum: {
    ...
    sidebar: {
      aboutTitle: 'حول',
      aboutDescription: 'مجتمع للباحثين والمعلمين الذين يستكشفون الذكاء الاصطناعي في تعلم اللغة والقراءة والكتابة.',
  ...
  admin: {
    ...
    categories: {
      ...
      deleteConfirm: {
        title: 'حذف الفئة',
        message:
          'هل أنت متأكد من حذف {name}؟ ستصبح المشاركات التي تستخدم هذه الفئة غير مصنفة.',
      },
      message: {

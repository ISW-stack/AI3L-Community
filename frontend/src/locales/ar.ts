export default {
  ...
  auth: {
    ...
    errors: {
      ...
      captcha_invalid: 'رمز التحقق غير صحيح، يرجى المحاولة مرة أخرى.',
      account_inactive: 'حسابك غير نشط، يرجى الاتصال بالمسؤول.',
      unknown: 'فشل تسجيل الدخول، يرجى المحاولة مرة أخرى.',
  ...
  errors: {
    ...
    unauthorized: 'ليس لديك صلاحية للقيام بهذا الإجراء.',
    captcha_invalid: 'رمز التحقق غير صحيح. يرجى المحاولة لاحقاً.',
    SYS_422: 'رمز التحقق غير صحيح. يرجى المحاولة لاحقاً.',
    account_inactive: 'حسابك غير نشط. يرجى الاتصال بالمسؤول.',
    ...
    registerFailed: 'فشل التسجيل. يرجى المحاولة لاحقاً.',
    guestLoginFailed: 'فشل دخول الضيف. يرجى المحاولة لاحقاً.',

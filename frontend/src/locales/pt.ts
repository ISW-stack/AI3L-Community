export default {
  ...
  post: {
    ...
    detail: {
      ...
      unsavedChangesMessage: 'Tem alterações não guardadas. Tem a certeza que quer sair desta página?',
      leaveBtn: 'Sair',
    },
    comment: {
      reply: 'Responder',
  ...
  forms: {
    builder: {
      ...
      confirmDiscard: 'Tem a certeza que quer descartar este rascunho? Esta ação não pode ser desfeita.',

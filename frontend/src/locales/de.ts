export default {
  ...
  dm: {
    ...
    recallConfirm: 'Diese Nachricht zurückrufen? Die andere Partei sieht „Nachricht zurückgerufen".',
  ...
  post: {
    ...
    detail: {
      ...
      unsavedChangesMessage: 'Sie haben nicht gespeicherte Änderungen. Möchten Sie diese Seite wirklich verlassen?',
      leaveBtn: 'Verlassen',
    },
    comment: {
      reply: 'Antworten',
  ...
  forms: {
    builder: {
      ...
      confirmDiscard: 'Möchten Sie diesen Entwurf wirklich verwerfen? Diese Aktion kann nicht rückgängig gemacht werden.',
